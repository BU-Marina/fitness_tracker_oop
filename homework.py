...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coeff_calorie_2 = 20
        min_in_hour = 60
        spent_calories = (coeff_calorie_1 * self.get_mean_speed() - coeff_calorie_2) * self.weight / self.M_IN_KM * self.duration * min_in_hour
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        min_in_hour = 60
        spent_calories = (coeff_calorie_1 * self.weight + (self.get_mean_speed()**2 // self.height) * coeff_calorie_2 * self.weight) * self.duration * min_in_hour
        return spent_calories
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    workout_codes = {'RUN': Running, 'WLK': SportsWalking, 'SWM': Swimming}
